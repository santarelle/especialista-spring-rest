...
public class RestauranteController {
    ...
    public Restaurante adicionar(@RequestBody @Validated(Group.CadastroRestaurante.class) Restaurante restaurante) {
        try {
    ...
    private void merge(Map<String, Object> dadosOrigem, Restaurante restauranteDestino, HttpServletRequest request) {
        ...
        try {
            ...
            throw new HttpMessageNotReadableException(ex.getMessage(), rootCouse, servletServerHttpRequest);
        }
