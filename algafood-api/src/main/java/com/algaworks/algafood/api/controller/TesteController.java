...
public class TesteController {
	...
	public List<Restaurante> restaurentPorNome(String nome, Long cozinhaId) {
	...
	@GetMapping("/restaurantes/conta-por-cozinha")
	public int restauranteContaPorCozinha(Long cozinhaId) {
